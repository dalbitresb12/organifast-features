Feature: US22: Minijuegos con RA
    ...
    Scenario: SC29: Visualización de minijuegos RA mediante a cámara
        ...
        Examples:
            | Menú       | Opción: RA | Minijuego                                | Display en pantalla (imagen)                                |
            | Minijuegos | Activada   | Pelea contra seres o búsqueda del tesoro | Visualización de cámara con el minijuego seleccionado en RA |
    ...
    Scenario: SC30: Falla en la visualización de la RA
        ...
        Examples:
            | Menú       | Opción: RA  | Minijuego                                | Mensaje                                            |
            | Minijuegos | Desactivada | Pelea contra seres o búsqueda del tesoro | Active los permisos de cámara para acceder a la RA |
        ...
        Examples:
            | Menú       | Opción: RA  | Minijuego                                | Mensaje                                                |
            | Minijuegos | Desactivada | Pelea contra seres o búsqueda del tesoro | Lo sentimos, su dispositivo no es compatible con la RA |
